...
SELECT ok(idoreports_get_sla_ok_percent(1,'2019-03-05 11:00', '2019-03-05 13:00') = 50.0,'Host 1 was down 1 out of 2 hours');
SELECT ok(idoreports_get_sla_ok_percent(1,'2019-03-05 12:00', '2019-03-05 13:00') = 0.0,'Host 1 was down during that period');
SELECT ok(idoreports_get_sla_ok_percent(1,'2019-03-05 13:00', '2019-03-05 14:00') = 0.0,'Host 1 was down during that period');
